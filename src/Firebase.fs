...
module Firebase =
    let [<Import("auth","firebase/firebase")>] auth: Auth.IExports = jsNative
    ...
    let [<Import("functions","firebase/firebase")>] functions: Functions.IExports = jsNative
    ...
    type [<AllowNullLiteral>] IExports =
        ...
        abstract messaging: Firebase.Messaging.MessagingFactory
        ...
        abstract functions: ?app: Firebase.App.App -> Firebase.Functions.Functions

    type [<AllowNullLiteral>] NextFn<'T> =
        [<Emit "$0($1...)">] abstract Invoke: value: 'T -> unit

    type ErrorFn =
        ErrorFn<obj>

    type [<AllowNullLiteral>] ErrorFn<'E> =
        [<Emit "$0($1...)">] abstract Invoke: error: 'E -> unit

    type [<AllowNullLiteral>] CompleteFn =
    ...
    type [<AllowNullLiteral>] Observer<'T, 'E> =
        abstract next: NextFn<'T> with get, set
        abstract error: ErrorFn<'E> with get, set
        abstract complete: CompleteFn with get, set

    type [<AllowNullLiteral>] Unsubscribe =
        [<Emit "$0($1...)">] abstract Invoke: unit -> unit
    ...
    type [<AllowNullLiteral>] User =
        ...
        abstract getIdTokenResult: ?forceRefresh: bool -> Promise<Firebase.Auth.IdTokenResult>
    ...
    module App =
        ...
        type [<AllowNullLiteral>] App =
            ...
            abstract delete: unit -> Promise<obj option>
            abstract messaging: Firebase.Messaging.MessagingFactory with get, set
            abstract name: string with get, set
            ...
            abstract functions: unit -> Firebase.Functions.Functions
    ...
    module Functions =
        ...
        type [<AllowNullLiteral>] HttpsCallableResult =
            abstract data: obj option

        type [<AllowNullLiteral>] HttpsCallable =
            [<Emit "$0($1...)">] abstract Invoke: ?data: obj option -> Promise<HttpsCallableResult>

        type [<AllowNullLiteral>] Functions =
            abstract httpsCallable: name: string -> HttpsCallable

        type [<AllowNullLiteral>] FunctionsStatic =
            [<Emit "new $0($1...)">] abstract Create: unit -> Functions

        type [<StringEnum>] [<RequireQualifiedAccess>] ErrorStatus =
            | Ok
            | Cancelled
            | Unknown
    ...
    module Auth =
        ...
        type [<AllowNullLiteral>] ActionCodeSettings =
            abstract android: obj option with get, set
            abstract handleCodeInApp: bool option with get, set
            abstract iOS: obj option with get, set
            abstract url: string with get, set

        type [<AllowNullLiteral>] AdditionalUserInfo =
            abstract isNewUser: bool with get, set
            abstract profile: Object option with get, set
            abstract providerId: string with get, set
        ...
        type [<AllowNullLiteral>] AuthSettings =
            abstract appVerificationDisabledForTesting: bool with get, set
        ...
        type [<AllowNullLiteral>] Auth =
            ...
            abstract fetchSignInMethodsForEmail: email: string -> Promise<obj option>
            abstract isSignInWithEmailLink: emailLink: string -> bool
            abstract getRedirectResult: unit -> Promise<obj option>
            abstract languageCode: string option with get, set
            abstract settings: Firebase.Auth.AuthSettings with get, set
            abstract onAuthStateChanged: nextOrObserver: U2<Firebase.Observer<obj option>, (Firebase.User option -> obj option)> * ?error: (Firebase.Auth.Error -> obj option) * ?completed: Firebase.Unsubscribe -> Firebase.Unsubscribe
            abstract onIdTokenChanged: nextOrObserver: U2<Firebase.Observer<obj option>, (Firebase.User option -> obj option)> * ?error: (Firebase.Auth.Error -> obj option) * ?completed: Firebase.Unsubscribe -> Firebase.Unsubscribe
            abstract sendSignInLinkToEmail: email: string * actionCodeSettings: Firebase.Auth.ActionCodeSettings -> Promise<obj option>
            ...
            abstract signInWithEmailLink: email: string * ?emailLink: string -> Promise<obj option>
            ...
            abstract updateCurrentUser: user: Firebase.User option -> Promise<obj option>
        ...
        type [<AllowNullLiteral>] AuthCredential =
            abstract providerId: string with get, set
            abstract signInMethod: string with get, set
        ...
        type [<AllowNullLiteral>] EmailAuthProvider =
            ...
            abstract EMAIL_PASSWORD_SIGN_IN_METHOD: string with get, set
            abstract EMAIL_LINK_SIGN_IN_METHOD: string with get, set
        ...
        type [<AllowNullLiteral>] EmailAuthProviderStatic =
            ...
            abstract credentialWithLink: email: string * emailLink: string -> Firebase.Auth.AuthCredential
        ...
        type [<AllowNullLiteral>] FacebookAuthProvider =
            ...
            abstract PROVIDER_ID: string with get, set
            abstract FACEBOOK_SIGN_IN_METHOD: string with get, set
        ...
        type [<AllowNullLiteral>] GithubAuthProvider =
            ...
            abstract PROVIDER_ID: string with get, set
            abstract GITHUB_SIGN_IN_METHOD: string with get, set
        ...
        type [<AllowNullLiteral>] GoogleAuthProvider =
            ...
            abstract PROVIDER_ID: string with get, set
            abstract GOOGLE_SIGN_IN_METHOD: string with get, set
        ...
        type [<AllowNullLiteral>] IdTokenResult =
            abstract token: string with get, set
            abstract expirationTime: string with get, set
            abstract authTime: string with get, set
            abstract issuedAtTime: string with get, set
            abstract signInProvider: string option with get, set
            abstract claims: obj with get, set

        type [<AllowNullLiteral>] PhoneAuthProvider =
            inherit PhoneAuthProvider_Instance
            abstract PROVIDER_ID: string with get, set
            abstract PHONE_SIGN_IN_METHOD: string with get, set
        ...
        type [<AllowNullLiteral>] TwitterAuthProvider =
            ...
            abstract PROVIDER_ID: string with get, set
            abstract TWITTER_SIGN_IN_METHOD: string with get, set
        ...
        type [<AllowNullLiteral>] UserCredential =
            abstract additionalUserInfo: Firebase.Auth.AdditionalUserInfo option with get, set
            abstract credential: Firebase.Auth.AuthCredential option with get, set
            abstract operationType: string option with get, set
            abstract user: Firebase.User option with get, set
    ...
    module Auth =
        let [<Import("Auth","firebase/firebase/auth")>] auth: Auth.IExports = jsNative
    ...
    module Messaging =
        ...
        type [<AllowNullLiteral>] MessagingFactory =
            [<Emit "$0($1...)">] abstract Invoke: ?app: Firebase.App.App -> Messaging
            abstract isSupported: unit -> bool

        type [<AllowNullLiteral>] Messaging =
            abstract deleteToken: token: string -> Promise<bool>
            abstract getToken: unit -> Promise<string option>
            abstract onMessage: nextOrObserver: U2<Firebase.NextFn<obj option>, Firebase.Observer<obj option>> * ?error: Firebase.ErrorFn * ?completed: Firebase.CompleteFn -> Firebase.Unsubscribe
            abstract onTokenRefresh: nextOrObserver: U2<Firebase.NextFn<obj option>, Firebase.Observer<obj option>> * ?error: Firebase.ErrorFn * ?completed: Firebase.CompleteFn -> Firebase.Unsubscribe
            abstract requestPermission: unit -> Promise<unit>
            abstract setBackgroundMessageHandler: callback: (obj option -> U2<Promise<obj option>, unit>) -> unit
            abstract useServiceWorker: registration: ServiceWorkerRegistration -> unit
            abstract usePublicVapidKey: b64PublicKey: string -> unit
    ...
    module Storage =
        ...
        type [<AllowNullLiteral>] UploadTask =
            ...
            abstract on: ``event``: Firebase.Storage.TaskEvent * ?nextOrObserver: U2<Firebase.Observer<obj option>, (Object -> obj option)> option * ?error: (Error -> obj option) option * ?complete: Firebase.Unsubscribe option -> Function
    ...
    module Firestore =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract Timestamp: TimestampStatic
        ...
        type [<AllowNullLiteral>] TimestampStatic =
            ...
            /// from 0 to 999,999,999 inclusive.</param>
        ...
        type [<AllowNullLiteral>] SnapshotListenOptions =
        ...
        type [<AllowNullLiteral>] GetOptions =
            ...
            abstract source: U3<string, string, string> option
        ...
        type [<AllowNullLiteral>] DocumentReference =
            ...
            /// <summary>Reads the document referred to by this `DocumentReference`.
            /// 
            /// Note: By default, get() attempts to provide up-to-date data when possible
            /// by waiting for data from the server, but it may return cached data or fail
            /// if you are offline and the server cannot be reached. This behavior can be
            /// altered via the `GetOptions` parameter.</summary>
            /// <param name="options">An object to configure the get behavior.</param>
            abstract get: ?options: GetOptions -> Promise<DocumentSnapshot>
            ...
            abstract onSnapshot: options: SnapshotListenOptions * observer: DocumentReferenceOnSnapshotObserver_ -> (unit -> unit)
            abstract onSnapshot: onNext: (DocumentSnapshot -> unit) * ?onError: (Error -> unit) * ?onCompletion: (unit -> unit) -> (unit -> unit)
            abstract onSnapshot: options: SnapshotListenOptions * onNext: (DocumentSnapshot -> unit) * ?onError: (Error -> unit) * ?onCompletion: (unit -> unit) -> (unit -> unit)
        ...
        type [<AllowNullLiteral>] Query =
            ...
            /// <summary>Executes the query and returns the results as a QuerySnapshot.
            /// 
            /// Note: By default, get() attempts to provide up-to-date data when possible
            /// by waiting for data from the server, but it may return cached data or fail
            /// if you are offline and the server cannot be reached. This behavior can be
            /// altered via the `GetOptions` parameter.</summary>
            /// <param name="options">An object to configure the get behavior.</param>
            abstract get: ?options: GetOptions -> Promise<QuerySnapshot>
            ...
            abstract onSnapshot: options: SnapshotListenOptions * observer: QueryOnSnapshotObserver_ -> (unit -> unit)
            abstract onSnapshot: onNext: (QuerySnapshot -> unit) * ?onError: (Error -> unit) * ?onCompletion: (unit -> unit) -> (unit -> unit)
            abstract onSnapshot: options: SnapshotListenOptions * onNext: (QuerySnapshot -> unit) * ?onError: (Error -> unit) * ?onCompletion: (unit -> unit) -> (unit -> unit)
        ...
        type [<AllowNullLiteral>] QuerySnapshot =
            ...
            abstract empty: bool
            /// <summary>Returns an array of the documents changes since the last snapshot. If this
            /// is the first snapshot, all documents will be in the list as added changes.</summary>
            /// <param name="options">`SnapshotListenOptions` that control whether metadata-only
            /// changes (i.e. only `DocumentSnapshot.metadata` changed) should trigger
            /// snapshot events.</param>
            abstract docChanges: ?options: SnapshotListenOptions -> ResizeArray<DocumentChange>
        ...
        type [<AllowNullLiteral>] FieldValue =
            /// <summary>Returns a special value that can be used with set() or update() that tells
            ...
            /// Returns true if this `FieldValue` is equal to the provided one.</summary>
